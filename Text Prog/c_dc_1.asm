...
PLUS        movf    RegL,W          ; Скопировать содержимое регистра RegL в регистр W.
            addwf   TimerL,F        ; Сложить содержимое регистров W и TimerL с сохранением
                                    ; суммы в регистре TimerL.

            btfss   Status,C        ; Флаг С поднят?
            goto    PLUS_1          ; Если нет, то переход в ПП PLUS_1.
            incf    TimerM,F        ; Если да, то инкремент содержимого регистра
...
PLUS_1      movf    RegM,W          ; Скопировать содержимое регистра RegM в регистр W.         
            addwf   TimerM,F        ; Сложить содержимое регистров W и TimerM с сохранением
                                    ; суммы в регистре TimerM.
            btfsc   Status,C        ; Флаг С поднят?
            incf    TimerH,F        ; Если да, то инкремент содержимого регистра
                                    ; TimerH с сохранением результата в нем же.
            movf    RegH,W          ; Если нет, то скопировать содержимое регистра RegH в регистр W.
